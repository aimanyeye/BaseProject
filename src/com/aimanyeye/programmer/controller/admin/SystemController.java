package com.aimanyeye.programmer.controller.admin;
...
import com.aimanyeye.programmer.entity.admin.User;
import com.aimanyeye.programmer.service.admin.AuthorityService;
import com.aimanyeye.programmer.service.admin.LogService;
import com.aimanyeye.programmer.service.admin.MenuService;
import com.aimanyeye.programmer.service.admin.RoleService;
import com.aimanyeye.programmer.service.admin.UserService;
import com.aimanyeye.programmer.util.CpachaUtil;
import com.aimanyeye.programmer.util.MenuUtil;
...
//	}
	...
	public Map<String, String> editPasswordAct(String newpassword,String oldpassword,HttpServletRequest request){
		...
		ret.put("type", "success");
		ret.put("msg", "密码修改成功！");
		logService.add("用户名为{"+user.getUsername()+"},成功修改密码!");
		return ret;
	} 
